...
Config.ActionLabel = {
    ["exit"] = "Para Salir",
    ["drawer"] = "Para abrir el ~y~armario~s~",
    ["wardrobe"] = "Para abrir el ~y~guardaropa~s~",
    ["invite"] = "Para invitar a ~y~Personas~s~"
}
...
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_FRONTEND_RDOWN~ Confirm and buy the room for ($" .. Config.MotelPrice .. ") ~n~"
